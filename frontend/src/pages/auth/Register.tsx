...
const Register = () => {
  ...
  const { isPending, mutate, isError, error } = useMutation({
    mutationFn: (payload: RegisterReq) => API_AUTH.REGISTER(payload),
    onSuccess: (res) => {
  ...
  return (
    <div className="flex flex-col gap-6 p-6">
      <h1 className="text-3xl">笨钟账单</h1>

      <h2 className="text-2xl">注册</h2>
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>请输入用户名</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>请输入密码</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>请再输入以确认密码</FormDescription>
                <FormMessage />
              </FormItem>
            )}
          />
      ...
      >
        <path
          ...
          transform="translate(-137.87214 -184.7043)"
          fill="#6c63ff"
        />
        <path
        ...
        />
        <path
          id="f6ad8881-531f-450f-af8c-ee430f91c944-31"
          data-name="Path 33"
        ...
        />
        <path
          id="fc886b53-8f7f-459a-8f46-dc88972f03c0-32"
          data-name="Path 34"
      ...
      <small className="text-center">
        made with <span className="animate-pulse">💖</span> by b1gben org
      </small>
    </div>
  );
};
